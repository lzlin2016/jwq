...
import com.jw.wq.widget.RatioImageView;
...
public class MeizhiListAdapter
    ...
    public MeizhiListAdapter(Context context, List<HomeData> meizhiList) {
        mList = meizhiList;
        mContext = context;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        HomeData meizhi = mList.get(position);
        int limit = 48;
